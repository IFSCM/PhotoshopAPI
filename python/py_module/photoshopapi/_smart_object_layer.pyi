...
class SmartObjectLayer_8bit(Layer_8bit):
    ...
    @linkage.setter
    def linkage(
        self: SmartObjectLayer_8bit, type: psapi.enum.LinkedLayerType
    ) -> None: ...
    def __init__(
    ...
    def replace(
        self: SmartObjectLayer_8bit, path: str, link_externally: bool = ...
    ) -> None: ...
    ...
    def get_raw_bytes(self: SmartObjectLayer_8bit) -> bytes: ...
    ...
    def rotate(
        self: SmartObjectLayer_8bit, angle: float, x: float, y: float
    ) -> None: ...
    def scale(
        self: SmartObjectLayer_8bit,
        x_scalar: float,
    ...
    def get_channel_by_index(
        self: SmartObjectLayer_8bit, key: int
    ) -> numpy.ndarray: ...
    def get_channel_by_id(
        self: SmartObjectLayer_8bit, key: psapi.enum.ChannelID
    ) -> numpy.ndarray: ...
...
class SmartObjectLayer_16bit(Layer_16bit):
    ...
    @linkage.setter
    def linkage(
        self: SmartObjectLayer_16bit, type: psapi.enum.LinkedLayerType
    ) -> None: ...
    def __init__(
    ...
    def replace(
        self: SmartObjectLayer_16bit, path: str, link_externally: bool = ...
    ) -> None: ...
    ...
    def get_raw_bytes(self: SmartObjectLayer_16bit) -> bytes: ...
    def get_original_image_data(
        self: SmartObjectLayer_16bit,
    ) -> Dict[int, numpy.ndarray]: ...
    ...
    def move(
        self: SmartObjectLayer_16bit, x_offset: float, y_offset: float
    ) -> None: ...
    def rotate(
        self: SmartObjectLayer_16bit, angle: float, x: float, y: float
    ) -> None: ...
    def scale(
        self: SmartObjectLayer_16bit,
        x_scalar: float,
    ...
    def get_channel_by_index(
        self: SmartObjectLayer_16bit, key: int
    ) -> numpy.ndarray: ...
    def get_channel_by_id(
        self: SmartObjectLayer_16bit, key: psapi.enum.ChannelID
    ) -> numpy.ndarray: ...
...
class SmartObjectLayer_32bit(Layer_32bit):
    ...
    @linkage.setter
    def linkage(
        self: SmartObjectLayer_32bit, type: psapi.enum.LinkedLayerType
    ) -> None: ...
    def __init__(
    ...
    def replace(
        self: SmartObjectLayer_32bit, path: str, link_externally: bool = ...
    ) -> None: ...
    ...
    def get_raw_bytes(self: SmartObjectLayer_32bit) -> bytes: ...
    def get_original_image_data(
        self: SmartObjectLayer_32bit,
    ) -> Dict[int, numpy.ndarray]: ...
    ...
    def move(
        self: SmartObjectLayer_32bit, x_offset: float, y_offset: float
    ) -> None: ...
    def rotate(
        self: SmartObjectLayer_32bit, angle: float, x: float, y: float
    ) -> None: ...
    def scale(
        self: SmartObjectLayer_32bit,
        x_scalar: float,
    ...
    def get_channel_by_index(
        self: SmartObjectLayer_32bit, key: int
    ) -> numpy.ndarray: ...
    def get_channel_by_id(
        self: SmartObjectLayer_32bit, key: psapi.enum.ChannelID
    ) -> numpy.ndarray: ...
